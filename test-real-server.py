...
route_script = f"{route}/scripts/real_server.jmx" # route script JMeter dentro de carpeta scripts
route_results = f"{route}/results/real_server_results.jtl" # route resultados JMeter dentro de carpeta results
